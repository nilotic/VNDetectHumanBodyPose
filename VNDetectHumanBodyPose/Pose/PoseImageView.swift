...
@IBDesignable final class PoseImageView: UIImageView {
    ...
    static let jointSegments = [ // The connected joints that are on the left side of the body.
    ...
    @IBInspectable var segmentColor: UIColor = .systemTeal
    ...
    @IBInspectable var jointColor: UIColor = .systemPink
