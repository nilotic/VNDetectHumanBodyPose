...
/// - Tag: PoseNetInput
final class PoseNetInput: MLFeatureProvider {
    ...
    func featureValue(for featureName: String) -> MLFeatureValue? {
        ...
        return try? MLFeatureValue(cgImage: imageFeature, pixelsWide: Int(imageFeatureSize.width), pixelsHigh: Int(imageFeatureSize.height), pixelFormatType: imageFeature.pixelFormatInfo.rawValue, options: options)
    }
}
